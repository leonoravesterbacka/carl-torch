...
parser.add_option('-p', '--datapath',  action='store', type=str, dest='datapath',  default='/eos/user/s/sjiggins/CARLAthena/Tuples-v2/Tuples/', help='path to where the data is stored')
